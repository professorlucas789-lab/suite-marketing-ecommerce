...
export type ActiveTab = "dashboard" | "products" | "add-product" | "batch-products" | "categories" | "edit-product" | "reverse-calculator" | "alertas" | "estoque" | "vendas" | "clientes" | "multi-loja" | "notificacoes" | "automacao" | "twilio-config" | "settings" | "history" | "reports" | "backup" | "users" | "stores" | "user-profile" | "diagnostics"; // NOVO (Fase 4 - Alertas) | NOVO (Fase 5 - Estoque) | NOVO (Fase 6 - Vendas/Clientes) | NOVO (Fase 9 - Multi-Loja) | NOVO (Fase 10 - Notificações/Automação) | NOVO (Fase 11 - Integração Twilio) | NOVO (Fase 11 - User Profile) | NOVO: diagnostics
